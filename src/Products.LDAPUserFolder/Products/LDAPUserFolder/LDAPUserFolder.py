...
# Groups that OODT is interested in:
_ourGroupsExpression = '(&(|(cn=edrn*)(cn=oodt*)(cn=cdx*)(cn=datasystechoffice*)(cn=mcl*))%s)'
# No longer care about: cdx, gisapps, or vodc
...
class LDAPUserFolder(BasicUserFolder):
    ...
    def getGroups(self, dn='*', attr=None, pwd=''):
        ...
        if self._local_groups:
            ...
            group_filter = _ourGroupsExpression % group_filter
